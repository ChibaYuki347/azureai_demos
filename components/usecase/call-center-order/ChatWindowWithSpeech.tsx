...
export function ChatWindowWithSpeech(props: {
  ...
  async function handleToggleMic() {
    ...
    if (isListening) {
      ...
      // TODO: token実装に変える
      speechConfig.current = sdk.SpeechConfig.fromSubscription(process.env.NEXT_PUBLIC_SPEECH_KEY, process.env.NEXT_PUBLIC_SPEECH_REGION);
  ...
  return (
    ...
    >
      ...
      <div
        className="mb-4 flex w-full flex-col-reverse overflow-auto transition-[grow] ease-in-out"
      ...
      <Toggle onClick={handleToggleMic}><Mic className="h-8 w-8" /></Toggle>
        </div>
        <h2>認識した音声</h2>
