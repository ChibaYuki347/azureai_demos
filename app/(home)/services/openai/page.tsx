...
// import { MaxLengthSelector } from "@/components/playground/max-length-selector";
...
// import { TemperatureSelector } from "@/components/playground/temprature-selector";
// import { TopPSelector } from "@/components/playground/top-p-selector";
import { models, presets } from "@/constants/playground";
import { Model, types } from "@/types/playground.d";
...
// };
// TODO:画面だけではなくのロジックを実装する
export default function PlaygroundPage() {
  const [selectedModel, setSelectedModel] = useState<Model>(models[0]);
  const [selectedPreset, setSelectedPreset] = useState(presets[0]);
  // console.log("parent: selectedModel", selectedModel);
  // console.log("parent: selectedPreset", selectedPreset);

  return (
    <>
      {/* <div className="md:hidden">
        <Image
          src="/assets/images/playground-light.png"
          width={1280}
          height={916}
          alt="Playground"
      ...
      <div className="hidden h-full flex-col md:flex">
        ...
        <Separator className="bg-light-800" />
